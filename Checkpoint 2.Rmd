...
boxplot(Attendance~Current.Wins,data=attendance.data) 
boxplot(Attendance~Current.Losses,data=attendance.data)
boxplot(Attendance~Tailgating,data=attendance.data)
boxplot(Attendance~New.Coach,data=attendance.data)
boxplot(Attendance~Year,data=attendance.data)
boxplot(Attendance~Month,data= attendance.data)
